 ...
 */
public class ForecastingChart extends ApplicationFrame
{
     ...
     */
    public ForecastingChart(String title, TimeSeries timeObservations, int len)
    {
        super(title);
    ...
    {
        TimeSeries observations = timeObservations;
        ...
        TimeSeries polyRegressSeries
            = getForecastTimeSeries(new PolynomialRegressionModel("t",4),
                                    initDataSet,
                                    0, 100,
                                    "Поліноміальна регресія 4-го порядку");
